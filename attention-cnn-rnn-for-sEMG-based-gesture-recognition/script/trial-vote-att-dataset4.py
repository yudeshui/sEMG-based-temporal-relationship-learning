...
from sigr.evaluation_cnnrnn_att_dataset4 import CrossValEvaluation as CV, Exp
from sigr.data_overlap_nobn_att1_db4_2 import Preprocess, Dataset
...
#                                           rnn_dropout=0.5,
#                                           rnn_window=29),
#                         params='.cache/srep-biopatrec-one-fold-intra-subject-%d-v2017.8.24-lstm-last0-h512-p0.5-cg1-w300-rw29-overlap-sw20-sp10-signal-3-2-1-fold2-fixp/model-0028.params'))],
#                folds=np.arange(5,6,1))
#     print('Signal image 150ms accuracy: %f' % acc.mean()) 
          ...
          [Exp(dataset=Dataset.from_name('biopatrec-db1/g26'), vote=1,
               ...
               Mod=dict(num_gesture=26,
                        ...
                        symbol_kargs=dict(dropout=0, 
                                          ...
                                          rnn_dropout=0.5,
                                          rnn_window=29),
                        params='.cache/srep-biopatrec-one-fold-intra-subject-%d-v2017.10.23-lstm-last0-h512-p0.5-cg1-w300-rw29-overlap-sw20-sp10-signal-3-2-1-fold0-fixp-att1-v/model-0010.params'))],
               folds=np.arange(16,17,1))
    print('Signal image 150ms accuracy: %f' % acc.mean()) 
